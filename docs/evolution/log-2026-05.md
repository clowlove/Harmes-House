...
- **gemini-youtube-automation** (298⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8412⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6040⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **mobile-mcp** (5388⭐): Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)
  - URL: https://github.com/mobile-next/mobile-mcp
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **mcp-agent** (8412⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6042⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **mobile-mcp** (5389⭐): Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)
  - URL: https://github.com/mobile-next/mobile-mcp
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **mcp-agent** (8412⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6044⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **mobile-mcp** (5390⭐): Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)
  - URL: https://github.com/mobile-next/mobile-mcp
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **WebRover** (993⭐): WebRover is an autonomous AI agent designed to interpret user input and execute actions by interacting with web elements to accomplish tasks or answer questions. It leverages advanced language models and web automation tools to navigate the web, gather information, and provide structured responses based on the user's needs.
  - URL: https://github.com/hrithikkoduri/WebRover
- **airecon** (789⭐): AIRecon is an autonomous cybersecurity agent that combines a self-hosted Large Language Model (Ollama) with a Kali Linux Docker sandbox and a Textual TUI. It is designed to automate security assessments, penetration testing, and bug bounty reconnaissance — without any API keys or cloud dependency.
  - URL: https://github.com/pikpikcu/airecon
- **gemini-youtube-automation** (299⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8411⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6047⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **mobile-mcp** (5397⭐): Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)
  - URL: https://github.com/mobile-next/mobile-mcp
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **WebRover** (993⭐): WebRover is an autonomous AI agent designed to interpret user input and execute actions by interacting with web elements to accomplish tasks or answer questions. It leverages advanced language models and web automation tools to navigate the web, gather information, and provide structured responses based on the user's needs.
  - URL: https://github.com/hrithikkoduri/WebRover
- **airecon** (791⭐): AIRecon is an autonomous cybersecurity agent that combines a self-hosted Large Language Model (Ollama) with a Kali Linux Docker sandbox and a Textual TUI. It is designed to automate security assessments, penetration testing, and bug bounty reconnaissance — without any API keys or cloud dependency.
  - URL: https://github.com/pikpikcu/airecon
- **gemini-youtube-automation** (299⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8413⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6048⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **mobile-mcp** (5398⭐): Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)
  - URL: https://github.com/mobile-next/mobile-mcp
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **gemini-youtube-automation** (299⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8414⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6050⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **mobile-mcp** (5401⭐): Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)
  - URL: https://github.com/mobile-next/mobile-mcp
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **gemini-youtube-automation** (299⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8415⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6054⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **mobile-mcp** (5404⭐): Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)
  - URL: https://github.com/mobile-next/mobile-mcp
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **WebRover** (993⭐): WebRover is an autonomous AI agent designed to interpret user input and execute actions by interacting with web elements to accomplish tasks or answer questions. It leverages advanced language models and web automation tools to navigate the web, gather information, and provide structured responses based on the user's needs.
  - URL: https://github.com/hrithikkoduri/WebRover
- **airecon** (790⭐): AIRecon is an autonomous cybersecurity agent that combines a self-hosted Large Language Model (Ollama) with a Kali Linux Docker sandbox and a Textual TUI. It is designed to automate security assessments, penetration testing, and bug bounty reconnaissance — without any API keys or cloud dependency.
  - URL: https://github.com/pikpikcu/airecon
- **gemini-youtube-automation** (299⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8414⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6055⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **mobile-mcp** (5412⭐): Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)
  - URL: https://github.com/mobile-next/mobile-mcp
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **mcp-agent** (8415⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6056⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **mobile-mcp** (5412⭐): Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)
  - URL: https://github.com/mobile-next/mobile-mcp
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
...
- **gemini-youtube-automation** (299⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8416⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6060⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **mobile-mcp** (5415⭐): Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)
  - URL: https://github.com/mobile-next/mobile-mcp
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **gemini-youtube-automation** (299⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8418⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6064⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **mobile-mcp** (5419⭐): Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)
  - URL: https://github.com/mobile-next/mobile-mcp
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **WebRover** (993⭐): WebRover is an autonomous AI agent designed to interpret user input and execute actions by interacting with web elements to accomplish tasks or answer questions. It leverages advanced language models and web automation tools to navigate the web, gather information, and provide structured responses based on the user's needs.
  - URL: https://github.com/hrithikkoduri/WebRover
- **airecon** (792⭐): AIRecon is an autonomous cybersecurity agent that combines a self-hosted Large Language Model (Ollama) with a Kali Linux Docker sandbox and a Textual TUI. It is designed to automate security assessments, penetration testing, and bug bounty reconnaissance — without any API keys or cloud dependency.
  - URL: https://github.com/pikpikcu/airecon
- **gemini-youtube-automation** (299⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8419⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6064⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **mobile-mcp** (5420⭐): Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)
  - URL: https://github.com/mobile-next/mobile-mcp
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **gemini-youtube-automation** (299⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8421⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6065⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **mobile-mcp** (5421⭐): Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)
  - URL: https://github.com/mobile-next/mobile-mcp
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **gemini-youtube-automation** (299⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8423⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6067⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5435⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
...
- **airecon** (793⭐): AIRecon is an autonomous cybersecurity agent that combines a self-hosted Large Language Model (Ollama) with a Kali Linux Docker sandbox and a Textual TUI. It is designed to automate security assessments, penetration testing, and bug bounty reconnaissance — without any API keys or cloud dependency.
  - URL: https://github.com/pikpikcu/airecon
- **gemini-youtube-automation** (300⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8423⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6066⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5439⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **WebRover** (993⭐): WebRover is an autonomous AI agent designed to interpret user input and execute actions by interacting with web elements to accomplish tasks or answer questions. It leverages advanced language models and web automation tools to navigate the web, gather information, and provide structured responses based on the user's needs.
  - URL: https://github.com/hrithikkoduri/WebRover
- **airecon** (794⭐): AIRecon is an autonomous cybersecurity agent that combines a self-hosted Large Language Model (Ollama) with a Kali Linux Docker sandbox and a Textual TUI. It is designed to automate security assessments, penetration testing, and bug bounty reconnaissance — without any API keys or cloud dependency.
  - URL: https://github.com/pikpikcu/airecon
- **gemini-youtube-automation** (301⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8423⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6068⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5442⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **WebRover** (993⭐): WebRover is an autonomous AI agent designed to interpret user input and execute actions by interacting with web elements to accomplish tasks or answer questions. It leverages advanced language models and web automation tools to navigate the web, gather information, and provide structured responses based on the user's needs.
  - URL: https://github.com/hrithikkoduri/WebRover
- **airecon** (795⭐): AIRecon is an autonomous cybersecurity agent that combines a self-hosted Large Language Model (Ollama) with a Kali Linux Docker sandbox and a Textual TUI. It is designed to automate security assessments, penetration testing, and bug bounty reconnaissance — without any API keys or cloud dependency.
  - URL: https://github.com/pikpikcu/airecon
- **gemini-youtube-automation** (301⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8424⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6071⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5449⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **airecon** (795⭐): AIRecon is an autonomous cybersecurity agent that combines a self-hosted Large Language Model (Ollama) with a Kali Linux Docker sandbox and a Textual TUI. It is designed to automate security assessments, penetration testing, and bug bounty reconnaissance — without any API keys or cloud dependency.
  - URL: https://github.com/pikpikcu/airecon
- **gemini-youtube-automation** (302⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8424⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6072⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5450⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **gemini-youtube-automation** (302⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8427⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6072⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5457⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **WebRover** (993⭐): WebRover is an autonomous AI agent designed to interpret user input and execute actions by interacting with web elements to accomplish tasks or answer questions. It leverages advanced language models and web automation tools to navigate the web, gather information, and provide structured responses based on the user's needs.
  - URL: https://github.com/hrithikkoduri/WebRover
- **airecon** (796⭐): AIRecon is an autonomous cybersecurity agent that combines a self-hosted Large Language Model (Ollama) with a Kali Linux Docker sandbox and a Textual TUI. It is designed to automate security assessments, penetration testing, and bug bounty reconnaissance — without any API keys or cloud dependency.
  - URL: https://github.com/pikpikcu/airecon
- **gemini-youtube-automation** (303⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8427⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6074⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5461⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **gemini-youtube-automation** (303⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8428⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6074⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5462⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **gemini-youtube-automation** (303⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8429⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6075⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5466⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **mcp-agent** (8429⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6076⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5470⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **airecon** (796⭐): AIRecon is an autonomous cybersecurity agent that combines a self-hosted Large Language Model (Ollama) with a Kali Linux Docker sandbox and a Textual TUI. It is designed to automate security assessments, penetration testing, and bug bounty reconnaissance — without any API keys or cloud dependency.
  - URL: https://github.com/pikpikcu/airecon
- **gemini-youtube-automation** (304⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8428⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6076⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5473⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (193⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **mcp-agent** (8429⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6078⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5478⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (194⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
  - URL: https://github.com/InternLM/ARM-Thinker
...
- **mcp-agent** (8429⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6079⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5480⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (194⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **WebRover** (996⭐): WebRover is an autonomous AI agent designed to interpret user input and execute actions by interacting with web elements to accomplish tasks or answer questions. It leverages advanced language models and web automation tools to navigate the web, gather information, and provide structured responses based on the user's needs.
  - URL: https://github.com/hrithikkoduri/WebRover
- **airecon** (796⭐): AIRecon is an autonomous cybersecurity agent that combines a self-hosted Large Language Model (Ollama) with a Kali Linux Docker sandbox and a Textual TUI. It is designed to automate security assessments, penetration testing, and bug bounty reconnaissance — without any API keys or cloud dependency.
  - URL: https://github.com/pikpikcu/airecon
- **gemini-youtube-automation** (304⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
...
- **mcp-agent** (8429⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6081⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5481⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (194⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **gemini-youtube-automation** (304⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8430⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6081⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5487⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (194⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **WebRover** (996⭐): WebRover is an autonomous AI agent designed to interpret user input and execute actions by interacting with web elements to accomplish tasks or answer questions. It leverages advanced language models and web automation tools to navigate the web, gather information, and provide structured responses based on the user's needs.
  - URL: https://github.com/hrithikkoduri/WebRover
- **airecon** (797⭐): AIRecon is an autonomous cybersecurity agent that combines a self-hosted Large Language Model (Ollama) with a Kali Linux Docker sandbox and a Textual TUI. It is designed to automate security assessments, penetration testing, and bug bounty reconnaissance — without any API keys or cloud dependency.
  - URL: https://github.com/pikpikcu/airecon
- **gemini-youtube-automation** (304⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
  - URL: https://github.com/ChaitanyaEswarRajeshJakki/gemini-youtube-automation
- **mcp-agent** (8430⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6082⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5491⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (194⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **mcp-agent** (8430⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6083⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5495⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (194⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **mcp-agent** (8430⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6088⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5496⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (194⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **WebRover** (997⭐): WebRover is an autonomous AI agent designed to interpret user input and execute actions by interacting with web elements to accomplish tasks or answer questions. It leverages advanced language models and web automation tools to navigate the web, gather information, and provide structured responses based on the user's needs.
  - URL: https://github.com/hrithikkoduri/WebRover
- **airecon** (797⭐): AIRecon is an autonomous cybersecurity agent that combines a self-hosted Large Language Model (Ollama) with a Kali Linux Docker sandbox and a Textual TUI. It is designed to automate security assessments, penetration testing, and bug bounty reconnaissance — without any API keys or cloud dependency.
  - URL: https://github.com/pikpikcu/airecon
- **gemini-youtube-automation** (304⭐): A fully autonomous AI Agent/Python pipeline that utilizes Large Language Models (LLMs) like Gemini to generate content, produce videos, and automatically upload educational videos to YouTube.
...
- **mcp-agent** (8430⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6090⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5500⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (194⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **XcodeBuildMCP** (6090⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5501⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (194⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **mcp-agent** (8430⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6092⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5505⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (194⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
...
- **mcp-agent** (8430⭐): Build effective agents using Model Context Protocol and simple workflow patterns
  - URL: https://github.com/lastmile-ai/mcp-agent
- **XcodeBuildMCP** (6093⭐): A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.
  - URL: https://github.com/getsentry/XcodeBuildMCP
- **notebooklm-mcp-cli** (5511⭐): Programmatic access to Google NotebookLM — via command-line interface (CLI), Model Context Protocol (MCP) server, and AI agent skills.
  - URL: https://github.com/jacob-bd/notebooklm-mcp-cli
- **EasyInstruct** (407⭐): [ACL 2024] An Easy-to-use Instruction Processing Framework for LLMs.
  - URL: https://github.com/zjunlp/EasyInstruct
- **ARM-Thinker** (194⭐): [CVPR 2026] Official Code for "ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning"
